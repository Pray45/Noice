...
export const DataProvider = ({ children }) => {
  ...
  const [currentsng, setCurrentsng] = useState()
  const [repeat, setRepeat] = useState(false)
  const [shuffle, setshuffle] = useState(false)


  return (
    <SongContext.Provider value={{  songs, album, artist, playlist, selectplaylist, setSelectplaylist, likedSongs, likeSong, loading, setLoading, queue, setQueue, currentsng, setCurrentsng, repeat, setRepeat, shuffle, setshuffle }}>
      {children}
