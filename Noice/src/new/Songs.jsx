                ...
                <div className="absolute z-10 mt-2 p-2 right-8 bg-[#1f0038] border border-gray-600 rounded shadow-md w-52">
                  <ul>
                    <li
                      onClick={(e) => {
                        e.stopPropagation();
                        setVisibleId(visibleId === song._id ? null : song._id);
                      }}
                    ...
                    {visibleId === song._id && (
                      <div className="absolute z-10 p-2 top-0 right-52 bg-[#1f0038] border border-gray-600 rounded shadow-md w-52">
                        {playlist.length === 0 ? (
                          <Link
                            to="/playlist"
                            className="px-4 py-2 w-full text-gray-400 text-sm block"
                          >
                    ...
                    <li
                      ...
                      className="flex items-center gap-2 rounded-md py-2 hover:bg-purple-950 cursor-pointer pl-2"
                    >
                      <PiQueueDuotone className="text-xl" />
                      Add to Queue
                    </li>
