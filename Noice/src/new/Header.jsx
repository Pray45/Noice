...
function Header({current, filteredSongs, type = "Artist"}) {
  ...
  return (
    <motion.div className="relative flex items-center gap-8 px-10 py-12 bg-gradient-to-r from-[#1d1030] via-[#3f1e54] to-[#070011] rounded-xl shadow-lg overflow-hidden" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }} >
        ...
        <motion.div className="relative z-10 w-64 h-64 flex-shrink-0" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} >
        ...
        <IoPlayCircle onClick={() => setQueue(filteredSongs)} className='text-6xl right-10 md:right-30 absolute bottom-10 cursor-pointer text-purple-600 duration-300 hover:text-purple-700 hover:scale-105'/>
